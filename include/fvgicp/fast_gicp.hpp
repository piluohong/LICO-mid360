...
public:
  ...
  std::shared_ptr<pcl::KdTreeFLANN<PointSource>> source_kdtree_;
  std::shared_ptr<pcl::KdTreeFLANN<PointTarget>> target_kdtree_;
protected:
  ...
  bool calculate_covariances(const typename pcl::PointCloud<PointT>::ConstPtr& cloud,pcl::KdTreeFLANN<PointT>& kdtree, CovarianceList& covariances, float& density);
