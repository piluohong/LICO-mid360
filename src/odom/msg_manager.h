...
namespace cocolic
{
  ...
  struct NextMsgs
  {
    ...
    void CheckData()
    {
      ...
      max_time[1] = 0;//pcl::GetCloudMaxTimeNs(lidar_corner_cloud) * NS_TO_S; // 不使用corner特征
    ...
    RTPointCloud::Ptr lidar_raw_cloud; // 所有点
    RTPointCloud::Ptr lidar_surf_cloud;// 面点
    RTPointCloud::Ptr lidar_corner_cloud; // 线点
  ...
  public:
    ...
    std::deque<ros::Time> timestamps_buf_;
  ...
  private:
    ...
    // ros::Subscriber subs_vlp16_;
    // ros::Subscriber subs_livox_;
